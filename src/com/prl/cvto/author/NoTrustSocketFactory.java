...
public class NoTrustSocketFactory extends SSLSocketFactory {
    ...
    public NoTrustSocketFactory(KeyStore truststore) throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException {
            super(truststore);
    ...
    public static HttpClient createMyHttpClient() {
            try {
                    ...
                    SSLSocketFactory mSSLSocketFactory = new NoTrustSocketFactory(trustStore);
